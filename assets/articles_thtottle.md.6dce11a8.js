import{_ as s,c as n,o as a,a as l}from"./app.837c4edc.js";const u=JSON.parse('{"title":"节流","description":"","frontmatter":{},"headers":[],"relativePath":"articles/thtottle.md","lastUpdated":1678332149000}'),p={name:"articles/thtottle.md"},e=l(`<h1 id="节流" tabindex="-1">节流 <a class="header-anchor" href="#节流" aria-hidden="true">#</a></h1><hr><p>持续触发事件，每隔一段时间，只执行一次事件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">/*</span></span>
