import{_ as s,c as a,o as n,a as l}from"./app.96a69404.js";const g=JSON.parse('{"title":"js小数计算丢失精度问题","description":"","frontmatter":{},"headers":[],"relativePath":"articles/lossPrecision.md","lastUpdated":1677576288000}'),t={name:"articles/lossPrecision.md"},e=l(`<h1 id="js小数计算丢失精度问题" tabindex="-1">js小数计算丢失精度问题 <a class="header-anchor" href="#js小数计算丢失精度问题" aria-hidden="true">#</a></h1><hr><h4 id="问题描述" tabindex="-1">问题描述 <a class="header-anchor" href="#问题描述" aria-hidden="true">#</a></h4><p>js在计算小数计算如0.1 + 0.2 的时候会丢失精度，即0.1 + 0.2= 0.30000000000000004;</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">console.log( 1 - 0.8 );  //输出 0.19999999999999996 </span></span>
