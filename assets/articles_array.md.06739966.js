import{_ as s,c as n,o as a,a as l}from"./app.96a69404.js";const h=JSON.parse('{"title":"数组","description":"","frontmatter":{},"headers":[],"relativePath":"articles/array.md","lastUpdated":1677568061000}'),p={name:"articles/array.md"},e=l(`<h1 id="数组" tabindex="-1">数组 <a class="header-anchor" href="#数组" aria-hidden="true">#</a></h1><hr><h4 id="at" tabindex="-1">at <a class="header-anchor" href="#at" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">let arr = [1, 2, 4, 5];</span></span>
